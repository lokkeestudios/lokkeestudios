...
function DatasetSelect(props) {
  ...
  var _useState = (0, _react.useState)(null),
      ...
      currentSpace = _useState2[0],
      setCurrentSpace = _useState2[1];

  (0, _react.useEffect)(() => {
    var currentSpace$ = _urlState.state.pipe((0, _operators.filter)(_urlState.isStateUpdateEvent), (0, _operators.map)(event => event.state && event.state.space), (0, _operators.map)(spaceName => _spaces.CONFIGURED_SPACES.find(sp => sp.name === spaceName)));

    var sub = currentSpace$.subscribe(setCurrentSpace);
    return () => {
      sub.unsubscribe();
    };
  }, []);
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Select, _extends({}, props, {
