...
var _toolMenuCollapse = require("./toolMenuCollapse");

Object.keys(_toolMenuCollapse).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _toolMenuCollapse[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _toolMenuCollapse[key];
    }
  });
});
