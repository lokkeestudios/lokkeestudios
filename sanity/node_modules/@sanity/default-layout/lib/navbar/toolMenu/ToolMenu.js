...
function ToolMenu(props) {
  ...
  return (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_ui.Stack, {
    as: "ul",
    space: [1, 2]
  }, tools.map(tool => {
    var title = tool.title || tool.name || undefined;

    var LinkComponent = linkProps => {
      return /*#__PURE__*/_react.default.createElement(_router.StateLink, _extends({}, linkProps, {
