...
function ThemeProvider(props) {
  var parentTheme = useContext(ThemeContext);
...
var Avatar = /*#__PURE__*/forwardRef(function Avatar(props, ref) {
  var asProp = props.as,
  ...
  var _useState = useState(animateArrowFrom || arrowPositionProp || 'inside'),
...
function childrenToElementArray(children) {
  ...
  return childrenArray.filter(function (node) {
    return isElement(node) || isFragment(node) || typeof node === 'string';
  });
}
...
var AvatarStack = /*#__PURE__*/forwardRef(function AvatarStack(props, ref) {
...
var Box = /*#__PURE__*/forwardRef(function Box(props, ref) {
...
var Label = /*#__PURE__*/forwardRef(function Label(props, ref) {
  var accent = props.accent,
      align = props.align,
      childrenProp = props.children,
      _props$muted = props.muted,
...
var Flex = /*#__PURE__*/forwardRef(function Flex(props, ref) {
...
var Checkbox = /*#__PURE__*/forwardRef(function Checkbox(props, forwardedRef) {
...
var Code = /*#__PURE__*/forwardRef(function Code(props, ref) {
  var children = props.children,
...
var Container = /*#__PURE__*/forwardRef(function Container(props, ref) {
  var as = props.as,
...
var Heading = /*#__PURE__*/forwardRef(function Heading(props, ref) {
  var _props$accent = props.accent,
      accent = _props$accent === void 0 ? false : _props$accent,
      align = props.align,
      childrenProp = props.children,
...
var Inline = /*#__PURE__*/forwardRef(function Inline(props, ref) {
  var as = props.as,
      childrenProp = props.children,
      space = props.space,
...
var KBD = /*#__PURE__*/forwardRef(function KBD(props, ref) {
  var children = props.children,
...
function useBoundaryElement() {
  var value = useContext(BoundaryElementContext); // NOTE: This check is for future-compatiblity
  // - If the value is not an object, it’s not compatible with the current version
  // - If the value is an object, but doesn’t have `version: 0.0`, it’s not compatible with the current version
...
var ElementQuery = /*#__PURE__*/forwardRef(function ElementQuery(props, ref) {
  var theme = useTheme();
...
function useLayer() {
  var value = useContext(LayerContext);
...
var Layer = /*#__PURE__*/forwardRef(function Layer(props, ref) {
  var children = props.children,
      _props$zOffset = props.zOffset,
...
function usePortal() {
  var value = useContext(PortalContext);
...
var SrOnly = /*#__PURE__*/forwardRef(function SrOnly(props, ref) {
  var as = props.as,
      children = props.children;
...
var VirtualList = /*#__PURE__*/forwardRef(function VirtualList(props, ref) {
  var _props$as = props.as,
...
var Radio = /*#__PURE__*/forwardRef(function Radio(props, forwardedRef) {
...
var Select = /*#__PURE__*/forwardRef(function Select(props, forwardedRef) {
  var children = props.children,
      customValidity = props.customValidity,
      disabled = props.disabled,
      _props$fontSize = props.fontSize,
...
var Stack = /*#__PURE__*/forwardRef(function Stack(props, ref) {
  var as = props.as,
      space = props.space,
...
var Switch = /*#__PURE__*/forwardRef(function Switch(props, forwardedRef) {
  var checked = props.checked,
      className = props.className,
      disabled = props.disabled,
      indeterminate = props.indeterminate,
...
var TextArea = /*#__PURE__*/forwardRef(function TextArea(props, forwardedRef) {
...
var TextInput = /*#__PURE__*/forwardRef(function TextInput(props, forwardedRef) {
  var _props$border = props.border,
      border = _props$border === void 0 ? true : _props$border,
  ...
  var handleClearMouseDown = useCallback(function (event) {
    event.preventDefault();
    event.stopPropagation();
  }, []);
  var handleClearClick = useCallback(function (event) {
    var _ref$current;
  ...
  var prefixNode = useMemo(function () {
    return prefix && /*#__PURE__*/React.createElement(Prefix, {
      borderTop: true,
      borderLeft: true,
      borderBottom: true,
      radius: radius,
  ...
  var presentationNode = useMemo(function () {
  ...
  var suffixNode = useMemo(function () {
    return suffix && /*#__PURE__*/React.createElement(Suffix, {
      borderTop: true,
      borderRight: true,
      borderBottom: true,
      radius: radius,
...
var ListBox = styled(Box)(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteralLoose(["\n  & > ul {\n    list-style: none;\n    padding: 0;\n    margin: 0;\n  }\n"])));
/**
 * @internal
 */
...
var AnimatedSpinnerIcon = styled(SpinnerIcon)(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteralLoose(["\n  animation: ", " 500ms linear infinite;\n"])), rotate);
...
var InnerAutocomplete = /*#__PURE__*/forwardRef(function InnerAutocomplete(props, ref) {
  var _props$border = props.border,
      border = _props$border === void 0 ? true : _props$border,
      customValidity = props.customValidity,
      disabled = props.disabled,
  ...
  var input = /*#__PURE__*/React.createElement(TextInput, _extends({}, restProps, {
...
var Breadcrumbs = /*#__PURE__*/forwardRef(function Breadcrumbs(props, ref) {
  var children = props.children,
  ...
  var items = useMemo(function () {
    ...
    if (maxLength && len > maxLength) {
      ...
      return [].concat(rawItems.slice(0, beforeLength - 1), [/*#__PURE__*/React.createElement(Popover, {
        constrainSize: true,
...
var DialogContent = styled(Box)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteralLoose(["\n  position: relative;\n  z-index: 1;\n  overflow: auto;\n  outline: none;\n"])));
var DialogFooter = styled(Box)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteralLoose(["\n  position: relative;\n  z-index: 3;\n  border-top: 1px solid var(--card-hairline-soft-color);\n"])));
var DialogCard = /*#__PURE__*/forwardRef(function DialogCard(props, ref) {
...
var Hotkeys = /*#__PURE__*/forwardRef(function Hotkeys(props, ref) {
...
var MenuButton = /*#__PURE__*/forwardRef(function MenuButton(props, ref) {
  ...
  var handleMenuClickOutside = useCallback(function (event) {
    var target = event.target;
  ...
  var handleMenuEscape = useCallback(function () {
    setOpen(false);
  ...
  var registerElement = useCallback(function (el) {
  ...
  var menu = isElement(menuProp) ? /*#__PURE__*/cloneElement(menuProp, menuProps) : null;
  var setButtonRef = useCallback(function (el) {
    if (typeof ref === 'function') {
      ref(el);
    } else if (ref) {
      ref.current = el;
  ...
  var button = useMemo(function () {
    return isElement(buttonProp) ? /*#__PURE__*/cloneElement(buttonProp, {
      'data-ui': 'MenuButton',
      id: id,
...
var MenuItem = /*#__PURE__*/forwardRef(function MenuItem(props, forwardedRef) {
  var _props$as = props.as,
      as = _props$as === void 0 ? 'button' : _props$as,
      children = props.children,
      disabled = props.disabled,
  ...
  var paddingProps = useMemo(function () {
    return {
      padding: padding,
      paddingX: paddingX,
      paddingY: paddingY,
...
var keyframe = keyframes(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteralLoose(["\n  0% {\n    background-position: 100%;\n  }\n  100% {\n    background-position: -100%;\n  }\n"])));
var animation = css(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteralLoose(["\n  background-image: linear-gradient(\n    to right,\n    var(--card-skeleton-color-from),\n    var(--card-skeleton-color-to),\n    var(--card-skeleton-color-from),\n    var(--card-skeleton-color-from),\n    var(--card-skeleton-color-from)\n  );\n  background-position: 100%;\n  background-size: 200% 100%;\n  background-attachment: fixed;\n  animation-name: ", ";\n  animation-timing-function: ease-in-out;\n  animation-iteration-count: infinite;\n  animation-duration: 2000ms;\n"])), keyframe);
/**
 * This API might change. DO NOT USE IN PRODUCTION.
 * @beta
 */

var skeletonStyle = css(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteralLoose(["\n  opacity: ", ";\n  transition: opacity 200ms ease-in;\n\n  @media screen and (prefers-reduced-motion: no-preference) {\n    ", "\n  }\n\n  @media screen and (prefers-reduced-motion: reduce) {\n    background-color: var(--card-skeleton-color-from);\n  }\n"])), function (_ref) {
  var $visible = _ref.$visible;
  return $visible ? 1 : 0;
}, function (_ref2) {
  var $animated = _ref2.$animated;
  return $animated ? animation : css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteralLoose(["\n            background-color: var(--card-skeleton-color-from);\n          "])));
});
...
var Skeleton = /*#__PURE__*/forwardRef(function Skeleton(props, ref) {
  ...
  var _useState = useState(delay ? false : true),
      visible = _useState[0],
...
var _excluded$7 = ["size"],
    ...
    _excluded3 = ["size"],
    _excluded4 = ["size"];
var Root$3 = styled(Skeleton)(function (_ref) {
  var $size = _ref.$size,
      $style = _ref.$style,
      theme = _ref.theme;
  var media = theme.sanity.media;
...
var TextSkeleton = /*#__PURE__*/forwardRef(function TextSkeleton(props, ref) {
...
var LabelSkeleton = /*#__PURE__*/forwardRef(function TextSkeleton(props, ref) {
...
var HeadingSkeleton = /*#__PURE__*/forwardRef(function TextSkeleton(props, ref) {
...
var CodeSkeleton = /*#__PURE__*/forwardRef(function TextSkeleton(props, ref) {
...
var Tab = /*#__PURE__*/forwardRef(function Tab(props, forwardedRef) {
  var icon = props.icon,
      id = props.id,
...
var TabList = /*#__PURE__*/forwardRef(function TabList(props, ref) {
  ...
  var handleTabFocus = useCallback(function (tabIdx) {
...
var TabPanel = /*#__PURE__*/forwardRef(function TabPanel(props, ref) {
  var flex = props.flex,
...
var Root$2 = styled(Card)(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteralLoose(["\n  pointer-events: all;\n"])));
var TextBox = styled(Flex)(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteralLoose(["\n  overflow-x: auto;\n"])));
/**
 * @public
 */
...
var Root$1 = styled(Layer)(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteralLoose(["\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  pointer-events: none;\n"])));
var ToastContainer = styled.div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteralLoose(["\n  box-sizing: border-box;\n  position: absolute;\n  right: 0;\n  bottom: 0;\n  max-width: 420px;\n  width: 100%;\n"])));
var toastId = 0;
/**
 * @public
 */
...
function ToastProvider(props) {
  ...
  var toastsRef = useRef({});
  var push = useCallback(function (params) {
...
function useToast() {
  var value = useContext(ToastContext);
...
function Tree(props) {
  ...
  var setExpanded = useCallback(function (path, expanded) {
    setState(function (s) {
      var _extends3;
...
function useTree() {
  var tree = useContext(TreeContext);
...
var ToggleArrowText = styled(Text)(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  & > svg {\n    transition: transform 100ms;\n  }\n"])));
/**
 * This API might change. DO NOT USE IN PRODUCTION.
 * @beta
 */
