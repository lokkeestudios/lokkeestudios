import type { PathBuilderOptions, ResolvedSanityFile, ResolvedSanityImage, SanityAssetSource, SanityFileAsset, SanityFileSource, SanityImageAsset, SanityImageDimensions, SanityImageSource, SanityProjectDetails } from './types';
/**
 ...
 * Throws if passed file source could not be resolved to an asset ID
 */
export declare function getFileAsset(src: SanityFileSource, options?: PathBuilderOptions): SanityFileAsset;
/**
 ...
 * @returns Returns `undefined` instead of throwing if a value cannot be resolved
 */
export declare const tryGetFileAsset: (src: SanityFileSource, options?: PathBuilderOptions | undefined) => any;
/**
