...
function buildImagePath(asset, options) {
  var projectId = (options === null || options === void 0 ? void 0 : options.projectId) || asset.projectId;
  var dataset = (options === null || options === void 0 ? void 0 : options.dataset) || asset.dataset;
...
function getVanityStub(originalFilename, vanityFilename, options) {
  ...
  return (options === null || options === void 0 ? void 0 : options.useVanityName) === false || !vanity ? '' : "/" + vanity;
}
