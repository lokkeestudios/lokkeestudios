...
var resolveDocumentChild = (itemId, _ref) => {
  var params = _ref.params,
      path = _ref.path;
  var type = params.type;
  var parentPath = path.slice(0, path.length - 1);
  var currentSegment = path[path.length - 1];
...
class DocumentBuilder {
  ...
  serialize() {
    ...
    if (!options || !options.type) {
      ...
      console.log("\u26A0\uFE0F Structure warning: document type (`schemaType`) will be required for document nodes in the near future! At:\n\n".concat(path.join(' > '), "\n"));
    }
    ...
    var dupes = (0, _uniq2.default)(viewIds.filter((viewId, i) => viewIds.includes(viewId, i + 1)));
