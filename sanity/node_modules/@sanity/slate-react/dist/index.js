...
var TextString = function TextString(props) {
  ...
  var ref = React.useRef(null); // This is the actual text rendering boundary where we interface with the DOM
...
var Editable$1 = function Editable(props) {
  ...
  useIsomorphicLayoutEffect(function () {
    ...
    if (newDomRange) {
      ...
      if (IS_FIREFOX && selection && startOffset === 1 && newDomRange.endOffset === 1 && newDomRange[slate.Range.isBackward(selection) ? 'endContainer' : 'startContainer'].textContent === "\uFEFF") {
        var node = slate.Node.parent(editor, selection.focus.path);
