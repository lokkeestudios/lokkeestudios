...
var SanityCrossDatasetReferenceInput = /*#__PURE__*/(0, _react.forwardRef)(function SanityCrossDatasetReferenceInput(props, ref) {
  ...
  var currentProject = _versionedClient.versionedClient.config().projectId;

  var isCurrentProject = currentProject === type.projectId;
  var loadableToken = (0, _useCrossProjectToken.useCrossProjectToken)(_versionedClient.versionedClient, {
    projectId: type.projectId,
    tokenId: type.tokenId
  });
  var crossDatasetClient = (0, _react.useMemo)(() => {
    var token = isCurrentProject ? undefined : loadableToken.status === 'loaded' && loadableToken.result;
  ...
  if (!isCurrentProject && loadableToken.status === 'loaded' && !loadableToken.result) {
    return /*#__PURE__*/_react.default.createElement(_ui.Stack, {
      ...
      size: 1,
      weight: "semibold"
    }, type.title), /*#__PURE__*/_react.default.createElement(_Alert.Alert, {
      ...
      size: 1
    }, "This cross dataset reference field requires a cross dataset token to be registered. Please configure a token", ' ', type.tokenId ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "with ID ", /*#__PURE__*/_react.default.createElement("b", null, type.tokenId)) : null, ' ', "for project ", /*#__PURE__*/_react.default.createElement("b", null, type.projectId), " that has read access to the ", /*#__PURE__*/_react.default.createElement("b", null, type.dataset), "-dataset."), /*#__PURE__*/_react.default.createElement(_ui.Text, {
      size: 1
