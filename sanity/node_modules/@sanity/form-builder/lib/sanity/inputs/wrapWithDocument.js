...
exports.wrapWithDocument = wrapWithDocument;
...
function wrapWithDocument(assetSource) {
  return _objectSpread(_objectSpread({}, assetSource), {}, {
    component: (0, _withDocument.default)(assetSource.component)
  });
}