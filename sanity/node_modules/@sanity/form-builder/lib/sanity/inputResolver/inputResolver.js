...
var _SanityCrossDatasetReferenceInput = _interopRequireDefault(require("../inputs/crossDatasetReference/SanityCrossDatasetReferenceInput"));
...
var CUSTOM_INPUT_MAP = {
  ...
  crossDatasetReference: _SanityCrossDatasetReferenceInput.default,
...
function resolveInputComponent(type) {
  ...
  var custom = typeof customResolver === 'function' && customResolver(type);
