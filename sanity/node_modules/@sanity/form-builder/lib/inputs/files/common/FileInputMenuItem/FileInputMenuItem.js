...
exports.FileInputMenuItem = void 0;
...
var _FileInputMenuItem = require("./FileInputMenuItem.styled");

var _excluded = ["icon", "id", "accept", "capture", "fontSize", "multiple", "onSelect", "padding", "space", "textAlign", "text", "disabled"];
...
var FileInputMenuItem = /*#__PURE__*/_react.default.forwardRef(function FileInputMenuItem(props, forwardedRef) {
  var icon = props.icon,
      idProp = props.id,
      accept = props.accept,
  ...
  return /*#__PURE__*/_react.default.createElement(_FileInputMenuItem.FileButton, _extends({}, rest, {
    htmlFor: id,
    padding: 0,
    fontSize: 2,
    disabled: disabled,
...
exports.FileInputMenuItem = FileInputMenuItem;