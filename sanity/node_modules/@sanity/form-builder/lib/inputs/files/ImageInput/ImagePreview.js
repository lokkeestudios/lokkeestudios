...
var _excluded = ["drag", "readOnly", "isRejected", "src"];
...
function ImagePreview(props) {
  ...
  var acceptTone = isRejected || readOnly ? 'critical' : 'primary';
  var tone = drag ? acceptTone : 'default';
  (0, _react.useEffect)(() => {
    /* set for when the src is being switched when the image input already had a image src
    - meaning it already had an asset */
    setLoaded(false);
  }, [src]);
  var onLoadChange = (0, _react.useCallback)(() => {
    setLoaded(true);
  }, []);
...
function HoverText(_ref2) {
  var isRejected = _ref2.isRejected,
      readOnly = _ref2.readOnly;
  var message = 'Drop image to upload';
