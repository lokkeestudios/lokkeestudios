...
function textBlockStyle(props) {
  ...
  return (0, _styledComponents.css)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    --marker-bg-color: transparent;\n\n    mix-blend-mode: ", ";\n    position: relative;\n\n    & > [data-ui='TextBlock_inner'] {\n      position: relative;\n      flex: 1;\n    }\n\n    & > div:before {\n      content: '';\n      position: absolute;\n      top: -", "px;\n      bottom: -", "px;\n      left: -", "px;\n      right: -", "px;\n      border-radius: ", "px;\n      background-color: var(--marker-bg-color);\n    }\n\n    &[data-custom-markers] {\n      --marker-bg-color: ", ";\n    }\n\n    &[data-warning] {\n      --card-border-color: ", ";\n      --marker-bg-color: ", ";\n    }\n\n    &[data-error] {\n      --card-border-color: ", ";\n      --marker-bg-color: ", ";\n    }\n\n    & [data-list-prefix] {\n      position: absolute;\n      margin-left: -4.5rem;\n      width: 3.75rem;\n      text-align: right;\n      box-sizing: border-box;\n    }\n\n    &[data-list-item='number'] [data-list-prefix] {\n      font-variant-numeric: tabular-nums;\n\n      & > span:before {\n        content: counter(", ") '.';\n        content: counter(", ", ", ") '.';\n      }\n    }\n\n    &[data-list-item='bullet'] [data-list-prefix] {\n      & > span {\n        position: relative;\n        top: -0.1875em;\n\n        &:before {\n          content: '", "';\n          font-size: 0.46666em;\n        }\n      }\n    }\n\n    & [data-text] {\n      overflow-wrap: anywhere;\n      text-transform: none;\n      white-space: pre-wrap;\n      font-family: ", ";\n      flex: 1;\n\n      *::selection {\n        background-color: ", ";\n      }\n    }\n  "])), color.dark ? 'screen' : 'multiply', space[1], space[1], space[1], space[1], radius[2], color.dark ? _color.hues.purple[950].hex : _color.hues.purple[50].hex, color.muted.caution.enabled.border, color.muted.caution.hovered.bg, color.muted.critical.enabled.border, color.muted.critical.hovered.bg, (0, _helpers.createListName)($level), (0, _helpers.createListName)($level), numberMarker, bulletMarker, fonts.text.family, color.selectable.primary.pressed.bg);
}

var TextRoot = _styledComponents.default.div(textBlockStyle);

exports.TextRoot = TextRoot;
var TextBlockFlexWrapper = (0, _styledComponents.default)(_ui.Flex)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  position: relative;\n"])));
...
var BlockActionsInner = (0, _styledComponents.default)(_ui.Flex)(_ref => {
  ...
  var buttonHeight = capHeight1 + space[2] + space[2]; // This calculates the following:
