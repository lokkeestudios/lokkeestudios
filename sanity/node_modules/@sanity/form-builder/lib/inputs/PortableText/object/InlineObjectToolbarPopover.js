...
exports.InlineObjectToolbarPopover = InlineObjectToolbarPopover;
...
function InlineObjectToolbarPopover(props) {
  var open = props.open,
      onEdit = props.onEdit,
  ...
  var popoverScheme = sanity.color.dark ? 'light' : 'dark';
  var isTabbing = (0, _react.useRef)(false); // Close floating toolbar on Escape
  ...
  }, /*#__PURE__*/_react.default.createElement(ToolbarPopover, {
