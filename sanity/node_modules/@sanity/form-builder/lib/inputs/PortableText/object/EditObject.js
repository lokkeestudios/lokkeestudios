...
var EditObject = props => {
  var focusPath = props.focusPath,
      markers = props.markers,
      objectEditData = props.objectEditData,
      onBlur = props.onBlur,
  ...
  var _useMemo = (0, _react.useMemo)(() => findObjectAndType(objectEditData, value, ptFeatures), [objectEditData, ptFeatures, value]),
      ...
      objectFromValue = _useMemo2[0],
      type = _useMemo2[1];

  var _useState = (0, _react.useState)(objectFromValue),
  ...
  var _useState3 = (0, _react.useState)(undefined),
      ...
      setTimeoutInstance = _useState4[1];

  var formBuilderPath = objectEditData && objectEditData.formBuilderPath;
  var kind = objectEditData && objectEditData.kind;
  var modalOption = (0, _react.useMemo)(() => (0, _helpers.getModalOption)({
    type
  }), [type]); // Initialize weakmaps on mount, and send patches on unmount
  ...
  var cancelThrottle = (0, _react.useMemo)(() => (0, _debounce2.default)(() => {
    IS_THROTTLING.set(editor, false);
  }, THROTTLE_MS), [editor]);
  var sendPatches = (0, _react.useCallback)(() => {
  ...
  if (modalOption.type === 'popover' || kind === 'annotation' && typeof modalOption.type === 'undefined') {
...
function findObjectAndType(objectEditData, value, ptFeatures) {
  ...
  if (block) {
    ...
    switch (kind) {
      ...
      case 'annotation':
        if (child) {
          var markDef = child.marks && block.markDefs && block.markDefs.find(def => child.marks.includes(def._key));
