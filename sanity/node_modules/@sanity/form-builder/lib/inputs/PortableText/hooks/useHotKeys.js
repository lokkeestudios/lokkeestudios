...
function useHotkeys(hotkeys) {
  var editor = (0, _portableTextEditor.usePortableTextEditor)(); // Guard that hotkeys from props will be a stable object.
  // If this props is defined inline and is always a new object, there will be issues with key handling and cursor!

  var initialHotkeys = (0, _react.useMemo)(() => hotkeys, []);
  ...
  return (0, _react.useMemo)(() => {
    ...
    return {
      marks: _objectSpread(_objectSpread({}, defaultHotkeys.marks), (initialHotkeys || {}).marks),
