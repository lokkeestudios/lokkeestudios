...
exports.ListCounterStory = ListCounterStory;
...
var BULLET_MARKERS = ['●', '○', '■'];
var NUMBER_FORMATS = ['number', 'lower-alpha', 'lower-roman'];
...
function ListCounterStory() {
  var debug = (0, _uiWorkshop.useBoolean)('Debug', false);
  var fontSize = (0, _uiWorkshop.useSelect)('Font size', FONT_SIZE_OPTIONS, 2);
  var space = (0, _uiWorkshop.useSelect)('Space', SPACE_OPTIONS, 3);
  return /*#__PURE__*/_react.default.createElement(_ui.Flex, {
    ...
    width: 1
  }, /*#__PURE__*/_react.default.createElement(EditableWrapper, {
    "data-debug": debug ? '' : undefined,
    space: space
  }, items.map((item, itemIndex) => /*#__PURE__*/_react.default.createElement(Block, {
    fontSize: fontSize,
    index: itemIndex,
    key: itemIndex,
    value: item
...
var BlockRoot = _styledComponents.default.div(props => {
...
function Block(props) {
  var fontSize = props.fontSize,
      index = props.index,
      value = props.value;
  return /*#__PURE__*/_react.default.createElement(BlockRoot, {
    $level: value.level || 0,
    ...
    "data-text": "",
    size: fontSize
  }, "Block ", /*#__PURE__*/_react.default.createElement("code", null, "#", index), value.level !== undefined && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, ", Level ", /*#__PURE__*/_react.default.createElement("code", null, "#", value.level))))));
}