...
var ItemRow = /*#__PURE__*/_react.default.forwardRef(function ItemRow(props, ref) {
  ...
  var hasError = markers.filter(_types.isValidationErrorMarker).length > 0;
  var hasWarning = markers.filter(_types.isValidationWarningMarker).length > 0;
  var showValidationStatus = !conditionalReadOnly && markers.length > 0 && !(type !== null && type !== void 0 && type.title);
  var showPresence = !(type !== null && type !== void 0 && type.title) && !conditionalReadOnly && presence.length > 0;
  var handleRemove = (0, _react.useCallback)(() => {
    onRemove(index);
  }, [index, onRemove]);
  var handleInsert = (0, _react.useCallback)((pos, insertType) => {
    onInsert === null || onInsert === void 0 ? void 0 : onInsert(pos, index, (0, _getEmptyValue.default)(insertType));
  }, [index, onInsert]);
  var handleDuplicate = (0, _react.useCallback)(() => {
    onInsert === null || onInsert === void 0 ? void 0 : onInsert('after', index, value);
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Card, {
    ...
    align: type ? 'flex-end' : 'center',
    ref: ref
  }, type ? /*#__PURE__*/_react.default.createElement(_ui.Flex, {
    align: "flex-end",
    flex: 1
    ...
    onBlur: onBlur,
    type: type,
    readOnly: Boolean(conditionalReadOnly !== null && conditionalReadOnly !== void 0 ? conditionalReadOnly : type.readOnly),
    level: level,
    presence: presence,
    onKeyUp: handleKeyUp,
  ...
  _react.default.createElement(_ui.Box, {
    ...
    presence: presence,
    maxAvatars: 1
  })), !conditionalReadOnly && /*#__PURE__*/_react.default.createElement(_ui.Box, {
    paddingY: 1
