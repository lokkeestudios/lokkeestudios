...
var _ConditionalHiddenField = require("../common/ConditionalHiddenField");
...
var ObjectInputField = /*#__PURE__*/(0, _react.forwardRef)(function ObjectInputField(props, forwardedRef) {
  ...
  var handleChange = (0, _react.useCallback)(event => {
    var isReadOnly = conditionalReadOnly !== null && conditionalReadOnly !== void 0 ? conditionalReadOnly : field.type.readOnly;
  ...
  }, [isValueCompatible, value, field.type, handleChange, fieldPath, onFocus, onBlur, focusPath, filterField, markers, compareValue, level, presence, parent, forwardedRef, conditionalReadOnly]);
  ...
  return /*#__PURE__*/_react.default.createElement(_ConditionalHiddenField.ConditionalHiddenField, {
    parent: props.parent,
    value: value,
