...
var _excluded = ["fieldset", "focusPath", "children", "level", "presence", "markers", "onFocus", "fieldValues", "fieldSetParent"];
...
var ObjectFieldSet = /*#__PURE__*/(0, _react.forwardRef)(function ObjectFieldSet(props, forwardedRef) {
  var fieldset = props.fieldset,
      ...
      fieldSetParent = props.fieldSetParent,
  ...
  return /*#__PURE__*/_react.default.createElement(_ConditionalHiddenField.ConditionalHiddenField, _extends({}, fieldset, {
    parent: fieldSetParent,
    value: fieldValues,
    hidden: fieldset.hidden
  }), /*#__PURE__*/_react.default.createElement(_components.FormFieldSet, _extends({}, rest, {
    key: fieldset.name,
