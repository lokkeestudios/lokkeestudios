...
var DUMMY_DOCUMENT_ID = '10053a07-8647-4ebd-9d1d-33a512d30d3a';
...
var schemaListOptions = (0, _mapValues2.default)((0, _keyBy2.default)(schemaMap, 'title'), 'name');
...
function getDummySchema(props) {
  var _props$schemaKey = props.schemaKey,
      schemaKey = _props$schemaKey === void 0 ? 'simple' : _props$schemaKey;
  var schemaType = schemaMap.find(s => s.name === schemaKey);
  var schema = schemaType.schema(props);
