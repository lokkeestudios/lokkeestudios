...
function withFocusRing(component) {
  return (0, _styledComponents.default)(component)(props => {
    var border = {
      width: props.$border ? 1 : 0,
      color: 'var(--card-border-color)'
    };
    return (0, _styledComponents.css)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        --card-focus-box-shadow: ", ";\n\n        border-radius: ", ";\n        outline: none;\n        box-shadow: var(--card-focus-box-shadow);\n\n        &:focus {\n          --card-focus-box-shadow: ", ";\n        }\n      "])), (0, _helpers.focusRingBorderStyle)(border), (0, _ui.rem)(props.theme.sanity.radius[1]), (0, _helpers.focusRingStyle)({
