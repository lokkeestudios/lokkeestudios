...
import { ImageAsset, AssetFromSource, Image as BaseImage, ImageSchemaType, Marker, ObjectField, Path } from '@sanity/types';
...
export default class ImageInput extends React.PureComponent<Props, ImageInputState> {
    ...
    renderAssetMenu(): JSX.Element;
    renderBrowser(): JSX.Element;
