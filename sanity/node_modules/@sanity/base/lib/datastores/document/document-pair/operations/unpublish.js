...
var unpublish = {
  ...
  execute: _ref2 => {
    ...
    if (snapshots.published) {
      tx = tx.createIfNotExists(_objectSpread(_objectSpread({}, (0, _omit2.default)(snapshots.published, '_updatedAt')), {}, {
        _id: idPair.draftId,
