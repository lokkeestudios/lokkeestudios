...
var operationArgs = (0, _createMemoizer.memoize)((idPair, typeName) => {
  return (0, _snapshotPair.snapshotPair)(idPair, typeName).pipe((0, _operators.switchMap)(versions => (0, _rxjs.combineLatest)([versions.draft.snapshots$, versions.published.snapshots$]).pipe((0, _operators.map)(_ref => {
