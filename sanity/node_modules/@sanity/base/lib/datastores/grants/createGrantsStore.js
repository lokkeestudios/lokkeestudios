...
function createGrantsStore() {
  var datasetGrants$ = (0, _rxjs.defer)(() => (0, _rxjs.of)(client.config())).pipe((0, _operators.switchMap)(_ref => {
  ...
  return {
    checkDocumentPermission(permission, document) {
      return currentUserDatasetGrants.pipe((0, _operators.switchMap)(grants => grantsPermissionOn(grants, permission, document)), (0, _operators.distinctUntilChanged)(_shallowEquals.default));
    }
