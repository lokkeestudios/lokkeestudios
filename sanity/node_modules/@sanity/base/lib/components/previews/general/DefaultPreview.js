...
var DEFAULT_MEDIA_DIMENSIONS = _objectSpread(_objectSpread({}, _constants.PREVIEW_MEDIA_SIZE.default), {}, {
  aspect: 1,
  fit: 'crop',
...
function DefaultPreview(props) {
  var title = props.title,
      ...
      styles = props.styles;
  var rootClassName = (0, _classnames.default)(styles === null || styles === void 0 ? void 0 : styles.root, Boolean(subtitle) && (styles === null || styles === void 0 ? void 0 : styles.hasSubtitle));

  var statusNode = status && /*#__PURE__*/_react.default.createElement(_ui.Box, {
