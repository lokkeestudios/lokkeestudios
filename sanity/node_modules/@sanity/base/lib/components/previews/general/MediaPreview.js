...
var _excluded = ["media", "mediaDimensions", "children", "isPlaceholder", "progress", "subtitle", "title", "withBorder", "withRadius"];
...
var DEFAULT_MEDIA_DIMENSIONS = _objectSpread(_objectSpread({}, _constants.PREVIEW_MEDIA_SIZE.media), {}, {
  aspect: 1,
  fit: 'crop',
...
function MediaPreview(props) {
  var media = props.media,
      ...
      progress = _props$progress === void 0 ? -1 : _props$progress,
  ...
  var STYLES_PADDER = (0, _react.useMemo)(() => ({
  ...
  return /*#__PURE__*/_react.default.createElement(_MediaPreview.RootBox, _extends({
