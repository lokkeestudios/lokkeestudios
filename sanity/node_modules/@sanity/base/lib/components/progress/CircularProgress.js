...
var Root = _styledComponents.default.svg(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  width: ", "px;\n  height: ", "px;\n  transform: rotate(-90deg);\n"])), SIZE, SIZE);

var BgCircle = _styledComponents.default.circle(_ref => {
  var theme = _ref.theme;
  var color = theme.sanity.color;
  return (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    fill: none;\n    stroke: ", ";\n    stroke-width: ", "px;\n  "])), _color.hues.gray[color.dark ? 900 : 100].hex, STROKE_WIDTH);
});

var ProgressCircle = _styledComponents.default.circle(_ref2 => {
...
function CircularProgress(props) {
  ...
  var value = Math.min(Math.max(valueProp, 0), 100);
  var radius = SIZE / 2 - STROKE_WIDTH / 2;
  var circ = 2 * Math.PI * radius;
  var offset = (100 - value) / 100 * circ;
  var viewBox = "".concat(SIZE / 2, " ").concat(SIZE / 2, " ").concat(SIZE, " ").concat(SIZE);
