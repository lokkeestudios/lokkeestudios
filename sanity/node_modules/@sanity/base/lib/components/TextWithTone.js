...
var _excluded = ["tone", "dimmed", "muted"];
...
var TextWithToneStyle = (0, _styledComponents.default)(_ui.Text)(_ref => {
  var $tone = _ref.$tone,
      theme = _ref.theme;
  var tone = theme.sanity.color.muted[$tone];
  return (0, _styledComponents.css)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      &:not([data-muted]) {\n        --card-fg-color: ", ";\n      }\n\n      &[data-dimmed] {\n        opacity: 0.3;\n      }\n    "])), tone ? tone.enabled.fg : undefined);
});
exports.TextWithToneStyle = TextWithToneStyle;

var TextWithTone = /*#__PURE__*/_react.default.forwardRef(function TextWithTone(props, ref) {
  var tone = props.tone,
      dimmed = props.dimmed,
      muted = props.muted,
