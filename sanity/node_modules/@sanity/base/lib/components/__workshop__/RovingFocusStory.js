...
var OPTIONS = [...Array(5).keys()];

function RovingFocusStory() {
  var direction = (0, _uiWorkshop.useSelect)('Direction', DIRECTION_OPTIONS, 'horizontal');
  var initialFocus = (0, _uiWorkshop.useSelect)('Initial focus', INITIAL_FOCUS, 'first');
  var loop = (0, _uiWorkshop.useBoolean)('Loop', true);
  var withDisabled = (0, _uiWorkshop.useBoolean)('With disabled elements', false);
