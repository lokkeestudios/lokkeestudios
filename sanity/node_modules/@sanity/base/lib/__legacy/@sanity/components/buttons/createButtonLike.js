...
function createButtonLike(as, _ref) {
  ...
  return _class = class ButtonLike extends _react.default.Component {
    constructor() {
      super(...arguments);
  ...
  }, _defineProperty(_class, "displayName", displayName || "ButtonLike(".concat(typeof Component === 'string' ? Component : Component.displayName || Component.name, ")")), _defineProperty(_class, "defaultProps", defaultProps), _class;
}