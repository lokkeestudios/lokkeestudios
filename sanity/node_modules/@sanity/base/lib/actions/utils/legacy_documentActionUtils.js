...
exports.resolveEnabledActions = exports.isActionEnabled = void 0;
...
var readActions = schemaType => {
  ...
  if (false && !(schemaType.name in hasWarned)) {
    console.warn("Heads up! Experimental actions is now deprecated and replaced by Document Actions. Read more about how to migrate on ".concat((0, _generateHelpUrl.generateHelpUrl)('experimental-actions-replaced-by-document-actions'), "\".\n"));
