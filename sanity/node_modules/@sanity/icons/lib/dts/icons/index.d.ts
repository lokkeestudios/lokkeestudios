 ...
 * @public
 */
export declare type IconSymbol = 'access-denied' | 'activity' | 'add-circle' | 'add' | 'api' | 'archive' | 'arrow-down' | 'arrow-left' | 'arrow-right' | 'arrow-top-right' | 'arrow-up' | 'bar-chart' | 'basket' | 'bell' | 'bill' | 'binary-document' | 'block-element' | 'blockquote' | 'bold' | 'book' | 'bottle' | 'bulb-filled' | 'bulb-outline' | 'calendar' | 'case' | 'chart-upward' | 'checkmark-circle' | 'checkmark' | 'chevron-down' | 'chevron-left' | 'chevron-right' | 'chevron-up' | 'circle' | 'clipboard' | 'clipboard-image' | 'clock' | 'close-circle' | 'close' | 'code-block' | 'code' | 'cog' | 'collapse' | 'comment' | 'component' | 'compose' | 'controls' | 'copy' | 'credit-card' | 'dashboard' | 'database' | 'desktop' | 'document' | 'document-remove' | 'documents' | 'download' | 'drag-handle' | 'drop' | 'earth-americas' | 'earth-globe' | 'edit' | 'ellipsis-horizontal' | 'ellipsis-vertical' | 'envelope' | 'equal' | 'error-filled' | 'error-outline' | 'expand' | 'eye-closed' | 'eye-open' | 'filter' | 'folder' | 'generate' | 'heart-filled' | 'heart' | 'help-circle' | 'home' | 'ice-cream' | 'image' | 'image-remove' | 'images' | 'info-filled' | 'info-outline' | 'inline-element' | 'insert-above' | 'insert-below' | 'italic' | 'joystick' | 'launch' | 'leave' | 'lemon' | 'link' | 'link-removed' | 'lock' | 'master-detail' | 'menu' | 'mobile-device' | 'moon' | 'ok-hand' | 'olist' | 'overage' | 'package' | 'pause' | 'pin' | 'pin-removed' | 'play' | 'plug' | 'presentation' | 'publish' | 'read-only' | 'remove-circle' | 'remove' | 'reset' | 'restore' | 'retrieve' | 'revert' | 'robot' | 'rocket' | 'search' | 'select' | 'sort' | 'spinner' | 'split-horizontal' | 'split-vertical' | 'square' | 'stack-compact' | 'star' | 'stop' | 'strikethrough' | 'sun' | 'sync' | 'tag' | 'terminal' | 'th-large' | 'th-list' | 'tiers' | 'toggle-arrow-right' | 'token' | 'transfer' | 'trash' | 'trend-upward' | 'triangle-outline' | 'trolley' | 'truncate' | 'ulist' | 'underline' | 'undo' | 'unknown' | 'unlock' | 'unpublish' | 'upload' | 'user' | 'users' | 'warning-filled' | 'warning-outline';
export { AccessDeniedIcon, ActivityIcon, AddCircleIcon, AddIcon, ApiIcon, ArchiveIcon, ArrowDownIcon, ArrowLeftIcon, ArrowRightIcon, ArrowTopRightIcon, ArrowUpIcon, BarChartIcon, BasketIcon, BellIcon, BillIcon, BinaryDocumentIcon, BlockElementIcon, BlockquoteIcon, BoldIcon, BookIcon, BottleIcon, BulbFilledIcon, BulbOutlineIcon, CalendarIcon, CaseIcon, ChartUpwardIcon, CheckmarkCircleIcon, CheckmarkIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, CircleIcon, ClipboardIcon, ClipboardImageIcon, ClockIcon, CloseCircleIcon, CloseIcon, CodeBlockIcon, CodeIcon, CogIcon, CollapseIcon, CommentIcon, ComponentIcon, ComposeIcon, ControlsIcon, CopyIcon, CreditCardIcon, DashboardIcon, DatabaseIcon, DesktopIcon, DocumentIcon, DocumentRemoveIcon, DocumentsIcon, DownloadIcon, DragHandleIcon, DropIcon, EarthAmericasIcon, EarthGlobeIcon, EditIcon, EllipsisHorizontalIcon, EllipsisVerticalIcon, EnvelopeIcon, EqualIcon, ErrorFilledIcon, ErrorOutlineIcon, ExpandIcon, EyeClosedIcon, EyeOpenIcon, FilterIcon, FolderIcon, GenerateIcon, HeartFilledIcon, HeartIcon, HelpCircleIcon, HomeIcon, IceCreamIcon, ImageIcon, ImageRemoveIcon, ImagesIcon, InfoFilledIcon, InfoOutlineIcon, InlineElementIcon, InsertAboveIcon, InsertBelowIcon, ItalicIcon, JoystickIcon, LaunchIcon, LeaveIcon, LemonIcon, LinkIcon, LinkRemovedIcon, LockIcon, MasterDetailIcon, MenuIcon, MobileDeviceIcon, MoonIcon, OkHandIcon, OlistIcon, OverageIcon, PackageIcon, PauseIcon, PinIcon, PinRemovedIcon, PlayIcon, PlugIcon, PresentationIcon, PublishIcon, ReadOnlyIcon, RemoveCircleIcon, RemoveIcon, ResetIcon, RestoreIcon, RetrieveIcon, RevertIcon, RobotIcon, RocketIcon, SearchIcon, SelectIcon, SortIcon, SpinnerIcon, SplitHorizontalIcon, SplitVerticalIcon, SquareIcon, StackCompactIcon, StarIcon, StopIcon, StrikethroughIcon, SunIcon, SyncIcon, TagIcon, TerminalIcon, ThLargeIcon, ThListIcon, TiersIcon, ToggleArrowRightIcon, TokenIcon, TransferIcon, TrashIcon, TrendUpwardIcon, TriangleOutlineIcon, TrolleyIcon, TruncateIcon, UlistIcon, UnderlineIcon, UndoIcon, UnknownIcon, UnlockIcon, UnpublishIcon, UploadIcon, UserIcon, UsersIcon, WarningFilledIcon, WarningOutlineIcon, };
/**
 * @public
 */
