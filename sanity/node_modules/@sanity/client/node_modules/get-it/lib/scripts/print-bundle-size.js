...
function output(res) {
  var text = ['UMD bundle size:', '────────────────', "Raw: ".concat(size(res[0].uncompressed)), "Raw + gzip: ".concat(size(res[0].compressed)), '', "Minified: ".concat(size(res[1].uncompressed)), "Minified + gzip: ".concat(size(res[1].compressed)), '', "Full bundle: ".concat(size(res[2].uncompressed)), "Full bundle + gzip: ".concat(size(res[2].compressed)), '', "Full bundle, minified: ".concat(size(res[3].uncompressed)), "Full bundle, minified + gzip: ".concat(size(res[3].compressed))].join('\n');
