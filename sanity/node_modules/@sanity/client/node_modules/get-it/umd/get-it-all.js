...
},{"./middleware/defaultOptionsProcessor":8,"./middleware/defaultOptionsValidator":9,"./request":26,"./util/middlewareReducer":29,"nano-pubsub":49}],3:[function(require,module,exports){
...
},{"object-assign":50,"url-parse":79}],9:[function(require,module,exports){
...
},{"object-assign":50}],11:[function(require,module,exports){
"use strict";var createErrorClass=require("create-error-class"),HttpError=createErrorClass("HttpError",function(r,t){var e=r.url.length>400?"".concat(r.url.slice(0,399),"…"):r.url,s="".concat(r.method,"-request to ").concat(e," resulted in ");s+="HTTP ".concat(r.statusCode," ").concat(r.statusMessage),this.message=s.trim(),this.response=r,this.request=t.options});module.exports=function(){return{onResponse:function(r,t){if(!(r.statusCode>=400))return r;throw new HttpError(r,t)}}};

},{"create-error-class":36}],12:[function(require,module,exports){
"use strict";exports.base=require("./base"),exports.debug=require("./debug"),exports.jsonRequest=require("./jsonRequest"),exports.jsonResponse=require("./jsonResponse"),exports.httpErrors=require("./httpErrors"),exports.retry=require("./retry"),exports.promise=require("./promise"),exports.observable=require("./observable"),exports.progress=require("./progress"),exports.headers=require("./headers"),exports.injectResponse=require("./injectResponse"),exports.urlEncoded=require("./urlEncoded"),exports.proxy=require("./proxy"),exports.keepAlive=require("./keepAlive");

},{"./base":3,"./debug":7,"./headers":10,"./httpErrors":11,"./injectResponse":13,"./jsonRequest":14,"./jsonResponse":15,"./keepAlive":16,"./observable":17,"./progress":19,"./promise":20,"./proxy":21,"./retry":22,"./urlEncoded":23}],13:[function(require,module,exports){
...
},{"object-assign":50}],14:[function(require,module,exports){
...
},{"is-plain-object":45,"object-assign":50}],15:[function(require,module,exports){
...
},{"object-assign":50}],16:[function(require,module,exports){
"use strict";var http=require("http"),https=require("https"),objectAssign=require("object-assign"),isHttpsProto=/^https:/i;module.exports=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e={keepAlive:!0,keepAliveMsecs:t.ms||1e3,maxFreeSockets:t.maxFree||256},s=new http.Agent(e),r=new https.Agent(e),i={http:s,https:r};return{finalizeOptions:function(t){if(t.agent)return t;var e=isHttpsProto.test(t.href||t.protocol),n=0===t.maxRedirects?{agent:e?r:s}:{agents:i};return objectAssign({},t,n)}}};

},{"http":72,"https":41,"object-assign":50}],17:[function(require,module,exports){
...
},{"../util/global":28,"object-assign":50}],18:[function(require,module,exports){
...
},{"./node-progress":18}],20:[function(require,module,exports){
"use strict";var Cancel=require("./cancel/Cancel"),CancelToken=require("./cancel/CancelToken"),isCancel=require("./cancel/isCancel"),globalPromise="function"==typeof Promise&&Promise,promise=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=e.implementation||globalPromise;if(!n)throw new Error("`Promise` is not available in global scope, and no implementation was passed");return{onReturn:function(o,i){return new n(function(n,r){var s=i.options.cancelToken;s&&s.promise.then(function(e){o.abort.publish(e),r(e)}),o.error.subscribe(r),o.response.subscribe(function(o){n(e.onlyBody?o.body:o)}),setTimeout(function(){try{o.request.publish(i)}catch(e){r(e)}},0)})}}};promise.Cancel=Cancel,promise.CancelToken=CancelToken,promise.isCancel=isCancel,module.exports=promise;

},{"./cancel/Cancel":4,"./cancel/CancelToken":5,"./cancel/isCancel":6}],21:[function(require,module,exports){
...
},{"object-assign":50}],22:[function(require,module,exports){
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}var objectAssign=require("object-assign"),defaultShouldRetry=require("../util/node-shouldRetry"),isStream=function(t){return null!==t&&"object"===_typeof(t)&&"function"==typeof t.pipe},retry=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=t.maxRetries||5,r=t.retryDelay||getRetryDelay,o=t.shouldRetry||defaultShouldRetry;return{onError:function(t,n){var u=n.options,y=u.maxRetries||e,i=u.shouldRetry||o,l=u.attemptNumber||0;if(isStream(u.body))return t;if(!i(t,l,u)||l>=y)return t;var s=objectAssign({},n,{options:objectAssign({},u,{attemptNumber:l+1})});return setTimeout(function(){return n.channels.request.publish(s)},r(l)),null}}};function getRetryDelay(t){return 100*Math.pow(2,t)+100*Math.random()}retry.shouldRetry=defaultShouldRetry,module.exports=retry;

},{"../util/node-shouldRetry":27,"object-assign":50}],23:[function(require,module,exports){
...
},{"form-urlencoded":40,"is-plain-object":45,"object-assign":50}],24:[function(require,module,exports){
...
},{"./browser/fetchXhr":25,"parse-headers":51,"same-origin":70}],25:[function(require,module,exports){
...
},{"./node-request":24}],27:[function(require,module,exports){
...
},{"base64-js":30,"buffer":32,"ieee754":42}],33:[function(require,module,exports){
...
},{"../../is-buffer/index.js":44}],36:[function(require,module,exports){
...
},{"capture-stack-trace":34}],37:[function(require,module,exports){
(function (process){
...
},{"./debug":38,"_process":53}],38:[function(require,module,exports){
...
},{"http":72,"url":80}],42:[function(require,module,exports){
...
},{"isobject":47}],46:[function(require,module,exports){
...
},{"./_stream_readable":61,"./_stream_writable":63,"core-util-is":35,"inherits":43,"process-nextick-args":52}],60:[function(require,module,exports){
...
},{"./_stream_transform":62,"core-util-is":35,"inherits":43}],61:[function(require,module,exports){
...
},{"./_stream_duplex":59,"./internal/streams/BufferList":64,"./internal/streams/destroy":65,"./internal/streams/stream":66,"_process":53,"core-util-is":35,"events":39,"inherits":43,"isarray":46,"process-nextick-args":52,"safe-buffer":69,"string_decoder/":76,"util":31}],62:[function(require,module,exports){
...
},{"./_stream_duplex":59,"core-util-is":35,"inherits":43}],63:[function(require,module,exports){
...
},{"./_stream_duplex":59,"./internal/streams/destroy":65,"./internal/streams/stream":66,"_process":53,"core-util-is":35,"inherits":43,"process-nextick-args":52,"safe-buffer":69,"timers":77,"util-deprecate":82}],64:[function(require,module,exports){
...
},{"safe-buffer":69,"util":31}],65:[function(require,module,exports){
...
},{"events":39}],67:[function(require,module,exports){
...
},{"buffer":32}],70:[function(require,module,exports){
...
},{"./lib/request":74,"./lib/response":75,"builtin-status-codes":33,"url":80,"xtend":83}],73:[function(require,module,exports){
(function (global){
...
},{"./capability":73,"./response":75,"_process":53,"buffer":32,"inherits":43,"readable-stream":67,"to-arraybuffer":78}],75:[function(require,module,exports){
(function (process,global,Buffer){
...
},{"./capability":73,"_process":53,"buffer":32,"inherits":43,"readable-stream":67}],76:[function(require,module,exports){
...
},{"safe-buffer":69}],77:[function(require,module,exports){
...
},{"process/browser.js":53,"timers":77}],78:[function(require,module,exports){
...
},{"buffer":32}],79:[function(require,module,exports){
(function (global){
...
},{"querystringify":58,"requires-port":68}],80:[function(require,module,exports){
