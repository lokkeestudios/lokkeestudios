...
function ListPane(props) {
  ...
  var shouldShowIconForItem = item => {
    ...
    var itemShowIcon = (_item$displayOptions = item.displayOptions) === null || _item$displayOptions === void 0 ? void 0 : _item$displayOptions.showIcon; // Specific true/false on item should have precedence over list setting
