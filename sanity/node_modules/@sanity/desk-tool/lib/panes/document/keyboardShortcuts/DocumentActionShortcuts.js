...
var _excluded = ["actionsBoxElement", "activeIndex", "children", "id", "onActionStart", "onKeyDown", "rootRef", "states"],
    _excluded2 = ["actionsBoxElement", "children"];
...
function KeyboardShortcutResponder(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_pane.Pane, _extends({
    id: id,
...
var DocumentActionShortcuts = /*#__PURE__*/_react.default.memo(props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_utils.RenderActionCollectionState, _extends({
    actions: actions,
