...
var Content = (0, _styledComponents.default)(_ui.Flex)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  opacity: 0;\n  transition: opacity 200ms;\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n"])));
/**
 * @internal
 */

var LoadingPane = /*#__PURE__*/(0, _react.memo)(props => {
  var _props$delay = props.delay,
      delay = _props$delay === void 0 ? 300 : _props$delay,
      flex = props.flex,
      messageProp = props.message,
      ...
      title = props.title,
      tone = props.tone;
  var resolvedMessage = (0, _react.useMemo)(() => {
  ...
  (0, _react.useEffect)(() => {
    ...
    var sub = resolvedMessage.subscribe(setCurrentMessage);
