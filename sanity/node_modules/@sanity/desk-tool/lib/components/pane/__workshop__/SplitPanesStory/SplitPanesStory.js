...
function SplitPanesStory() {
  var debug = (0, _uiWorkshop.useBoolean)('Debug', false) || false;
  ...
  var handleCollapse = (0, _react.useCallback)(() => setLayoutCollapsed(true), []);
  var handleExpand = (0, _react.useCallback)(() => setLayoutCollapsed(false), []);
...
function DeskTool(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_PaneLayout.PaneLayout, {
    ...
    var key = "".concat(s, "-").concat(i);

    var pane = _config.panes.find(p => p.id === s);
