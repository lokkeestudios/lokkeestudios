...
exports._sortElements = _sortElements;

var _getDOMPath2 = require("./_getDOMPath");
...
function _sortElements(rootElement, elements) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      map.set(element, (0, _getDOMPath2._getDOMPath)(rootElement, element));
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
