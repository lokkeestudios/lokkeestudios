...
import { BlockSchemaType, ArraySchemaType, ObjectSchemaType, ReferenceSchemaType, SpanSchemaType, TitledListValue, SpanChildrenObjectField, StyleObjectField, ListObjectField } from './types';
...
export declare function isStyleObjectField(field: unknown): field is StyleObjectField;
export declare function isListObjectField(field: unknown): field is ListObjectField;
export declare function isSpanChildrenObjectField(field: unknown): field is SpanChildrenObjectField;
