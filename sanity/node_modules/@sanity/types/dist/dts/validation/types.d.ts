 ...
 * @see CustomValidator
 */
export declare type BlockValidator = (block: Block, options: ValidationContext) => ValidationError[] | ValidationError | string | true | Promise<ValidationError[] | ValidationError | string | true>;
