...
class LoginDialog extends _react.default.Component {
  ...
  redirectToProvider(provider) {
    ...
    var params = ["origin=".concat(currentUrl), projectId && "projectId=".concat(projectId), "type=".concat(type)].filter(Boolean);
    ...
    if (provider.custom && !provider.supported && !this.state.error) {
      this.setState({
        error: {
          ...
          link: (0, _generateHelpUrl.generateHelpUrl)('third-party-login'),
          hideClose: true
        }
      });
      return;
  ...
  render() {
    ...
    var _this$props2 = this.props,
        ...
        SanityLogo = _this$props2.SanityLogo;
