...
exports.defaultKeyGenerator = exports.PortableTextEditor = void 0;
...
class PortableTextEditor extends _react.default.Component {
  constructor(props) {
    ...
    _defineProperty(this, "slateInstance", void 0);
    ...
    this.state = state;
    this.slateInstance = (0, _withPortableText.withPortableText)((0, _slate.createEditor)(), {
...
_defineProperty(PortableTextEditor, "getValue", editor => {
  ...
  return (_editor$editable9 = editor.editable) === null || _editor$editable9 === void 0 ? void 0 : _editor$editable9.getValue();
});

_defineProperty(PortableTextEditor, "hasBlockStyle", (editor, blockStyle) => {
  var _editor$editable10;

  return (_editor$editable10 = editor.editable) === null || _editor$editable10 === void 0 ? void 0 : _editor$editable10.hasBlockStyle(blockStyle);
});

_defineProperty(PortableTextEditor, "hasListStyle", (editor, listStyle) => {
  var _editor$editable11;

  return (_editor$editable11 = editor.editable) === null || _editor$editable11 === void 0 ? void 0 : _editor$editable11.hasListStyle(listStyle);
});

_defineProperty(PortableTextEditor, "isCollapsedSelection", editor => {
  var _editor$editable12;

  return (_editor$editable12 = editor.editable) === null || _editor$editable12 === void 0 ? void 0 : _editor$editable12.isCollapsedSelection();
});

_defineProperty(PortableTextEditor, "isExpandedSelection", editor => {
  var _editor$editable13;

  return (_editor$editable13 = editor.editable) === null || _editor$editable13 === void 0 ? void 0 : _editor$editable13.isExpandedSelection();
});

_defineProperty(PortableTextEditor, "isMarkActive", (editor, mark) => {
  var _editor$editable14;

  return (_editor$editable14 = editor.editable) === null || _editor$editable14 === void 0 ? void 0 : _editor$editable14.isMarkActive(mark);
});
...
_defineProperty(PortableTextEditor, "insertChild", (editor, type, value) => {
  ...
  return (_editor$editable15 = editor.editable) === null || _editor$editable15 === void 0 ? void 0 : _editor$editable15.insertChild(type, value);
});

_defineProperty(PortableTextEditor, "insertBlock", (editor, type, value) => {
  var _editor$editable16;

  return (_editor$editable16 = editor.editable) === null || _editor$editable16 === void 0 ? void 0 : _editor$editable16.insertBlock(type, value);
});

_defineProperty(PortableTextEditor, "isVoid", (editor, element) => {
  var _editor$editable17;

  return (_editor$editable17 = editor.editable) === null || _editor$editable17 === void 0 ? void 0 : _editor$editable17.isVoid(element);
});

_defineProperty(PortableTextEditor, "isObjectPath", (editor, path) => {
...
_defineProperty(PortableTextEditor, "marks", editor => {
  ...
  return (_editor$editable18 = editor.editable) === null || _editor$editable18 === void 0 ? void 0 : _editor$editable18.marks();
});
...
_defineProperty(PortableTextEditor, "select", (editor, selection) => {
  ...
  (_editor$editable19 = editor.editable) === null || _editor$editable19 === void 0 ? void 0 : _editor$editable19.select(selection);
});

_defineProperty(PortableTextEditor, "removeAnnotation", (editor, type) => {
  var _editor$editable20;

  return (_editor$editable20 = editor.editable) === null || _editor$editable20 === void 0 ? void 0 : _editor$editable20.removeAnnotation(type);
});
...
_defineProperty(PortableTextEditor, "toggleBlockStyle", (editor, blockStyle) => {
  ...
  return (_editor$editable21 = editor.editable) === null || _editor$editable21 === void 0 ? void 0 : _editor$editable21.toggleBlockStyle(blockStyle);
});

_defineProperty(PortableTextEditor, "toggleList", (editor, listStyle) => {
  var _editor$editable22;

  return (_editor$editable22 = editor.editable) === null || _editor$editable22 === void 0 ? void 0 : _editor$editable22.toggleList(listStyle);
});
...
_defineProperty(PortableTextEditor, "toggleMark", (editor, mark) => {
  ...
  (_editor$editable23 = editor.editable) === null || _editor$editable23 === void 0 ? void 0 : _editor$editable23.toggleMark(mark);
});