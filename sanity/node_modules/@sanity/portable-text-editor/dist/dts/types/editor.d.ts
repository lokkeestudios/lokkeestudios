...
import { ListItem, PortableTextBlock, PortableTextChild, TextBlock, TextSpan } from '../types/portableText';
...
export declare type ScrollSelectionIntoViewFunction = (editor: PortableTextEditor, domRange: globalThis.Range) => void | null;
