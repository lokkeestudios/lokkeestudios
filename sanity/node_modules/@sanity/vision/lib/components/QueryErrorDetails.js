...
var _QueryErrorDialog = require("./QueryErrorDialog.styled");
...
function QueryErrorDetails(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_QueryErrorDialog.ErrorCode, {
    size: 1
  }, "".concat(details.line, "\n").concat(dashLine(details.column, details.columnEnd))), /*#__PURE__*/_react.default.createElement(_ui.Box, {
    marginTop: 4
  }, /*#__PURE__*/_react.default.createElement(_QueryErrorDialog.ErrorCode, {
    size: 1
  }, "Line:   ".concat(details.lineNumber, "\nColumn: ").concat(details.column))));
}
